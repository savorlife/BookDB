			...
			<div class="layui-col-md12">
				<div class="layui-card">
					<div class="layui-card-body ">
						<form class="layui-form layui-col-space5" action="${path }/bookList">

							<div class="layui-inline layui-show-xs-block">
								<input type="number" name="book_id" placeholder="请输入图书编号"
					...
					<div class="layui-card-header">
						...
						<button class="layui-btn"
							onclick="xadmin.open('添加图书','${path}/admin/bookAdd.jsp',620,560)">
							  ...
							  <c:forEach items="${bookList }" var="book" varStatus="status">
								<tr>
									<td>${book.id }</td>
							          ...
							          <td>${book.kucun }</td>
							          <td>
							          <p  class="p" style="width: 220px; height: 60px;">
							          ${book.content }
							          </p>
							          </td>
									...
									<td class="td-manage"><a title="编辑"
										onclick="xadmin.open('编辑','/bookDB/findBookById?id=${book.id }')"
										href="javascript:;"> <i class="layui-icon">&#xe642;</i>
									</a> 
									<a title="删除"
										href="javascript:deleteAdmin(${book.id });">
											<i class="layui-icon">&#xe640;</i>
									</a></td>
								</tr>
								</c:forEach>
...
//   	  window.open ("kl.jsp", "", "height=200, width=400, top=400, left=400");
      ...
      function deleteAdmin(id){
		var r=confirm("您确定删除此图书吗？");
		if (r==true){
			  window.location.href="${path}/bookDelete?id="+id;
		}
