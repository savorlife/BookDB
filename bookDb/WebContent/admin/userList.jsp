			...
			<div class="layui-col-md12">
				<div class="layui-card">
					<div class="layui-card-body ">
						<form class="layui-form layui-col-space5" action="${path }/userByName">

							<div class="layui-inline layui-show-xs-block">
								<input type="text" name="content" placeholder="请输入搜素内容"
					...
					<div class="layui-card-header">
						...
						<button class="layui-btn"
							onclick="xadmin.open('添加用户','${path}/admin/userAdd.jsp',600,400)">
							    ...
							    <c:when test="${typeList == null}">
							       ...
							       <tr>
									...
									<td class="td-manage"><a title="编辑"
										onclick="xadmin.open('编辑','/bookDB/userFindId?id=${type.u_id }')"
										href="javascript:;"> <i class="layui-icon">&#xe642;</i>
									</a> 
									<a title="删除"
										href="javascript:deleteAdmin(${type.u_id });">
											<i class="layui-icon">&#xe640;</i>
									</a></td>
								</tr>
...
//   	  window.open ("kl.jsp", "", "height=200, width=400, top=400, left=400");
      ...
      function deleteAdmin(id){
		var r=confirm("您确定删除ID为"+id+"的用户吗？");
		if (r==true){
			  window.location.href="${path}/userDel?id="+id;
		}
